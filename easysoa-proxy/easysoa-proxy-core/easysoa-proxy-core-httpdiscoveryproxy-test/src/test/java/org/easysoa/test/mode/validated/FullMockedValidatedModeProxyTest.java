...
package org.easysoa.test.mode.validated;
...
public class FullMockedValidatedModeProxyTest extends AbstractProxyTestStarter
{
    ...
    public final void testRestValidatedMode() throws Exception
    {
        ...
        String nuxeoQuery = "SELECT * FROM Document WHERE ecm:path STARTSWITH '/default-domain/workspaces/' AND dc:title =" +
        		" 'show' AND ecm:currentLifeCycleState <> 'deleted' ORDER BY ecm:path";
