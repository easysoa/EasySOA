...
public class Run {
     ...
     *
     * @return The run start <code>Date</code> or null if the start date has not
     * been set before
     */
     ...
     *
     * @return The run stop <code>Date</code> or null if the stop date has not
     * been set before.
     */
