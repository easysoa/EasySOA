...
public interface RunManager {
    ...
    /**
     * Returns the current run. if there is no current run and autoStart is set
     * to true, a new run is automatically started (autostart), otherwise null
     * is returned
     *
    ...
    /**
     * Starts a new run. A new
     * <code>Run</code> is started only if the current run was stopped before
     * with a call to the stop() method.
     *
     * @param runName The name of the run. Must be unique, the name is the id of
     * the run.
     */
