    ...
    public void handleMessage(InMessage inMessage, OutMessage outMessage) throws Exception {
        ...
        if (enabled && hasValidConfiguration()) {
            ...
            if(isSoapMessage || isGetWsdlMessage){
                ...
                properties.put(Endpoint.XPATH_ENDP_HOST, inMessage.getServer());
                properties.put(Endpoint.XPATH_ENDP_IPADDRESS, inMessage.getServer()); // TODO : Host or IP address stored in the same field in Inmessage
