 ...
 */
package org.easysoa.proxy.core.api.configurator;
...
public class ProxyConfigurator {
    ...
    /**
     * Call only one time Configuration of logger
     *
     * @param clazz the class to use to get resources with the class loader
     * mechanism
     */
