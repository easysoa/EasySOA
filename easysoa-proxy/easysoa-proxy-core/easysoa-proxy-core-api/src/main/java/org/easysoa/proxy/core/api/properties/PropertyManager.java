...
/**
 * Property manager. Contains method to load property file and method to get property values.
 *
 * @author jguillemotte
 *
 */
public class PropertyManager {
     ...
     * @return The value corresponding to the property, the default value if a
     * problem occurs
     */
