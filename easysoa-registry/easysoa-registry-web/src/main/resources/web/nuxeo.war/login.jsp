...
<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">
  <tbody>
    <tr class="topBar">
      <td>
        <img alt="EasySOA Core" src="<%=context%>/img/easysoa/LogoCore100.png"/>
      </td>
      <td align="right" class="leftColumn">
        <div class="labelCorp">
          <ul>
            ...
            <li>
               <span style="font-size: 11px">Nuxeo :</span>
            </li>
          </ul>
    ...
    <tr>
      <td align="center" style="border-top: 2px solid #444">
      ...
      <td class="news_container" align="right" valign="center" style="border-top: 2px solid #444">
&nbsp;
