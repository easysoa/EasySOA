...
public interface FraSCAtiServiceItf
{
     ...
     */
    String[] processContribution(String contribution, int processingMode, Properties properties,
     ...
     *            ProcessingContext
     * @param properties
     *            properties are used to be passed to the processing context
     * @param urls
     *            a set of URLs to build the FraSCAti ProcessingContext
     ...
     */
    Composite processComposite(String composite, int processingMode, Properties properties, URL... urls)
            throws FraSCAtiServiceException;
