...
public abstract class FraSCAtiScaImporterBase extends AbstractScaImporterBase {
    ...
    public void importSCA() throws Exception {
        // If the filename is not set, it is not possible to choose the
        // corresponding
        // import method
    ...
    /**
     * Import all the composite contained in the zip archive requires all ref'd
     * composites and classes to be there TODO rather replace by old XML one ??
     * 
     * @throws Exception
     */
    public void importSCAZip() throws Exception {
        ...
        // Replace this code, record the content of the composite in the new tmp
        // composite
    ...
    public void importSCAComposite() throws Exception {
        ...
        // Initialization
        // TODO works only with physical files, add modifications to work with
        // composite
        // objects
        // Make 2 different constructors : one with file, other with composite
        // and then
        // make tests like the following code
        /*
         * if(this.compositeFile != null){ // Import sca file } else if
         * this.scaComposite != null { // Import sca composite } else { //
         * Throws an error }
         */
