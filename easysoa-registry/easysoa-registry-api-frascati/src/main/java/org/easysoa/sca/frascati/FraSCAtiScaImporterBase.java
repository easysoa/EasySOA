...
public abstract class FraSCAtiScaImporterBase extends AbstractScaImporterBase {
	 ...
	 */
	public FraSCAtiScaImporterBase(BindingVisitorFactory bindingVisitorFactory,
			FraSCAtiServiceItf frascatiService,
			File compositeFile) throws FrascatiException{
