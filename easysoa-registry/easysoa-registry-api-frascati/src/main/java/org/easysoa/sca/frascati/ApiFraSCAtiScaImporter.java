...
public class ApiFraSCAtiScaImporter extends FraSCAtiScaImporterBase implements FraSCAtiRuntimeScaImporterItf {
	 ...
	 * @throws Exception
	 */
	public ApiFraSCAtiScaImporter(BindingVisitorFactory bindingVisitorFactory,
			FraSCAtiServiceItf frascatiService, File scaComposite) throws Exception {
		super(bindingVisitorFactory, frascatiService, scaComposite);
	}
