...
/**
 * Allows for easy testing of EasySOA Core non-UI code within EasySOA Core
 * tests.
...
@Deploy({
        ...
        "org.nuxeo.ecm.platform.types.core", // can't see it ?!
                                             // "service:org.easysoa.core.contrib.ecmtypes requires [service:org.nuxeo.ecm.platform.types]"
        "org.nuxeo.ecm.actions", // can't see it ?!
                                 // "service:org.easysoa.core.contrib.actions requires [service:org.nuxeo.ecm.platform.actions]"
        "org.nuxeo.ecm.platform.forms.layout.core",
        "org.nuxeo.ecm.platform.forms.layout.client",
        "org.nuxeo.ecm.platform.content.template",
        "org.nuxeo.runtime.datasource"
// "org.easysoa.registry.core:OSGI-INF/core-type-contrib.xml", // required, else
// no custom types
// "org.easysoa.registry.core:OSGI-INF/vocabularies-contrib.xml", // required,
// else no custom easysoa vocabularies
// "org.easysoa.registry.core:OSGI-INF/users-contrib.xml",
// "org.easysoa.registry.core:OSGI-INF/HttpDownloaderService.xml",
// "org.easysoa.registry.core:OSGI-INF/eventlistener-contrib.xml", // required
// to enable the specific doctype listeners
// "org.easysoa.registry.core:OSGI-INF/lifecycle-contrib.xml",
// "org.easysoa.registry.core:OSGI-INF/DocumentServiceComponent.xml", //
// required to find the service through the Framework class
...
@LocalDeploy("org.easysoa.registry.core:test/vocabularies-contrib.xml")
