...
public class IndicatorsControllerTest extends AbstractRestApiTest {
    ...
    public void testIndicators() throws Exception {
        ...
        SoaNodeId endpoint0Id = new SoaNodeId(Endpoint.DOCTYPE, "MyEndpoint0");
        discoveryService.runDiscovery(documentManager, endpoint0Id, null, Arrays.asList(service0Id));
