...
public class DocumentTemplate implements TemplateHashModelEx,
    ...
    public TemplateCollectionModel keys() throws TemplateModelException {
        return new CollectionAndSequence(new SimpleSequence(getRawKeys(), wrapper)); //TOOD patched
    }
    ...
    public TemplateCollectionModel values() throws TemplateModelException {
        return new CollectionAndSequence(new SimpleSequence(getRawValues(), wrapper)); //TOOD patched
    }
