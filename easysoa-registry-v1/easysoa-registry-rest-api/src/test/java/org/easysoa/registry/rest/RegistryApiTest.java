...
public class RegistryApiTest extends AbstractWebEngineTest {
    ...
    public void create() throws Exception {
        ...
        SoaNodeInformation resultSoaNodeInfo = discoveryRequest.post(SoaNodeInformation.class, soaNodeInfo);
    ...
    public void update() throws Exception {
        ...
        Client client = createAuthenticatedHTTPClient();
        Builder discoveryRequest = client.resource(discoveryApi.getRootURL()).type(MediaType.APPLICATION_JSON);
        SoaNodeInformation resultSoaNodeInfo = discoveryRequest.put(SoaNodeInformation.class, soaNodeInfo);


        // Check result
        Assert.assertEquals("Title must have been updated",
                "My New Title", resultSoaNodeInfo.getProperties().get("dc:title"));
    }
