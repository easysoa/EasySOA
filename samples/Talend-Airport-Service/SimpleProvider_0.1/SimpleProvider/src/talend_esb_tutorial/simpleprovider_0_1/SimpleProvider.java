	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (resourcePath != null) {
				...
				this.setProperty("resourcePath", resourcePath.toString());
					...
					while (true) {
						try {
							...
							for (org.dom4j.tree.AbstractNode temp_tXMLMap_1 : nodeList_tXMLMap_1) { // G_TXM_M_001
								...
								// "org.talend.designer.xmlmap.model.emf.xmlmap.impl.InputXmlTreeImpl@f77a0d (expressionFilter: null, activateExpressionFilter: false, activateCondensedTool: false, minimized: false, name: row5) (lookup: true, matchingMode: UNIQUE_MATCH, lookupMode: LOAD_ONCE, innerJoin: true, persistent: false)"
								// /////////////////////////////////////////////
				...
				try {
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.resourcePath + "/countryInfos.csv",
								"ISO-8859-15", ";", "\n", true, 0, 0, -1, -1,
								false);
					} catch (Exception e) {
					...
					if (!((Object) (context.resourcePath + "/countryInfos.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			if (isDefaultContext && inContext == null) {
				...
				context.resourcePath = (String) context
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("resourcePath")) {
				context.resourcePath = (String) parentContextMap
						.get("resourcePath");
			}
		}
...
/************************************************************************************************
 * 85446 characters generated by Talend ESB Standard Edition on the 11 octobre
 * 2011 14:32:34 CEST
 ************************************************************************************************/
