...
@WebServiceClient(name = "Trip", 
                  wsdlLocation = "file:/data/home/jguillemotte/tests/ClientGalaxy/GalaxyTrip.wsdl",
...
public class Trip extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/data/home/jguillemotte/tests/ClientGalaxy/GalaxyTrip.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Trip.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/data/home/jguillemotte/tests/ClientGalaxy/GalaxyTrip.wsdl");
        }
        WSDL_LOCATION = url;
    }
