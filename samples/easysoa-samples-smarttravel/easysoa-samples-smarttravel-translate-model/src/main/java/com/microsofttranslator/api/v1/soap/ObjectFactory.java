...
public class ObjectFactory {
    ...
    private final static QName _TranslateAppId_QNAME = new QName("http://api.microsofttranslator.com/v1/soap.svc", "appId");
    ...
    public JAXBElement<String> createTranslateAppId(String value) {
        return new JAXBElement<String>(_TranslateAppId_QNAME, String.class, Translate.class, value);
    }
    ...
    public JAXBElement<String> createDetectAppId(String value) {
        return new JAXBElement<String>(_TranslateAppId_QNAME, String.class, Detect.class, value);
    }
    ...
    public JAXBElement<String> createGetLanguagesAppId(String value) {
        return new JAXBElement<String>(_TranslateAppId_QNAME, String.class, GetLanguages.class, value);
    }
    ...
    public JAXBElement<String> createGetLanguageNamesAppId(String value) {
        return new JAXBElement<String>(_TranslateAppId_QNAME, String.class, GetLanguageNames.class, value);
    }
