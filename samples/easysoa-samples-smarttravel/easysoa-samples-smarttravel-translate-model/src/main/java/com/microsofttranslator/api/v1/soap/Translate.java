...
public class Translate {
    ...
    @XmlElementRef(name = "text", namespace = "http://api.microsofttranslator.com/v1/soap.svc", type = JAXBElement.class)
    protected JAXBElement<String> text;
    @XmlElementRef(name = "from", namespace = "http://api.microsofttranslator.com/v1/soap.svc", type = JAXBElement.class)
    protected JAXBElement<String> from;
    @XmlElementRef(name = "to", namespace = "http://api.microsofttranslator.com/v1/soap.svc", type = JAXBElement.class)
