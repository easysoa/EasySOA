...
public class CurrencyServerWebServiceSoapImpl1 implements CurrencyServerWebServiceSoap {
    ...
    public double getDollarValue(java.lang.String provider,java.lang.String currency) { 
        ...
        try {
            //double _return = 0.8589112160963485;
        	double _return = 10.5;
            return _return;
    ...
    public java.lang.String getProviderTimestamp(java.lang.String providerId,java.lang.String provider) { 
        ...
        System.out.println(provider);
        try {
            java.lang.String _return = "_return1235004376";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String getProviderList() { 
        ...
        try {
            java.lang.String _return = "_return1127540112";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public java.lang.String getXmlStream(java.lang.String provider) { 
        ...
        System.out.println(provider);
        try {
            java.lang.String _return = "_return-1153909062";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
    ...
    public double getCurrencyValue(java.lang.String provider,java.lang.String srcCurrency,java.lang.String dstCurrency) { 
        ...
        try {
            //double _return = 0.21323533714587117;
        	double _return = 10.5;            
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
    ...
    public java.lang.String getProviderDescription(java.lang.String provider) { 
        ...
        System.out.println(provider);
        try {
            java.lang.String _return = "_return1466840983";
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
