...
//@WebService(targetNamespace = "http://www.webserviceX.NET", name = "GlobalWeatherSoap", serviceName = "GlobalWeather")
...
public interface GlobalWeatherSoap {
    ...
    @WebResult(name = "return", targetNamespace = "http://www.webserviceX.NET")
