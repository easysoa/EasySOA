...
public final class LanguageService_BasicHttpBindingLanguageService_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        ArrayOfstring _getLanguageNames__return = port.getLanguageNames(_getLanguageNames_appId, _getLanguageNames_locale);
        ...
        ArrayOfstring _getLanguages__return = port.getLanguages(_getLanguages_appId);
