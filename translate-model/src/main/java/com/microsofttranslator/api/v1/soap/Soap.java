 ...
 * 
 */
@WebServiceClient(name = "Soap", targetNamespace = "http://api.microsofttranslator.com/v1/soap.svc", wsdlLocation = "http://api.microsofttranslator.com/V1/Soap.svc?WSDL")
public class Soap
    extends Service
{
    ...
    public Soap() {
        super(SOAP_WSDL_LOCATION, new QName("http://api.microsofttranslator.com/v1/soap.svc", "Soap"));
    }
